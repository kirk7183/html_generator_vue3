export { default as Main_left }
    from '@/views/themes/theme-1/desktop/Main-left.vue'
export { default as Main_center }
    from '@/views/themes/theme-1/desktop/Main-center.vue'
export { default as Main_right }
    from '@/views/themes/theme-1/desktop/Main-right.vue'
export { default as Img_left }
    from '@/views/themes/theme-1/desktop/Img-left.vue'
export { default as Img_right }
    from '@/views/themes/theme-1/desktop/Img-right.vue'
